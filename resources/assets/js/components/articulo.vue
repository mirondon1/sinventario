    ...
    export default {
        ...
        methods : {
            ...
            validarArticulo(){
                ...
                if (!this.codigo) this.errorMostrarMsjArticulo.push("El codigo del articulo no puede estar vacío.");
                if (!this.nombre) this.errorMostrarMsjArticulo.push("El nombre del articulo no puede estar vacío.");
                if (!this.precio_compra) this.errorMostrarMsjArticulo.push("El precio de compra del articulo no puede estar vacío.");
                if (!this.stock) this.errorMostrarMsjArticulo.push("El stock del articulo no puede estar vacío.");
                if (!this.stock_minimo) this.errorMostrarMsjArticulo.push("El stock minimo del articulo no puede estar vacío.");
